...
class AddAmountComponentWidget extends StatefulWidget {
  const AddAmountComponentWidget({
    Key key,
  ...
  @override
  _AddAmountComponentWidgetState createState() =>
      _AddAmountComponentWidgetState();
}
